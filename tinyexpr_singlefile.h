...
/*
    =============================================
    || SINGLE-FILE VERSION OF TINYEXPR LIBRARY ||
    =============================================

    [#] Define TINYEXPR_IMPLEMENTATION before including this file
        (and do it only in ONE place!) otherwise linker will complain.
*/
...
#ifdef TINYEXPR_IMPLEMENTATION

#if defined(TINYEXPR_IMPLEMENTATION_DONE)
#pragma error "TINYEXPR_IMPLEMENTATION already defined somewhere!"
#else

#define TINYEXPR_IMPLEMENTATION_DONE
...
#endif // TINYEXPR_IMPLEMENTATION_DONE
#endif // TINYEXPR_IMPLEMENTATION