## TinyExpr single-file

This repo contains TinyExpr library (https://github.com/codeplea/tinyexpr) in a single .h header file which may be preferred over source + header combination in some cases.
Only readme and license from the original repo are included here.

### Usage
You must use `#define TINYEXPR_IMPLEMENTATION` before including this file (and do it only in ONE place/file!) otherwise linker will complain.
